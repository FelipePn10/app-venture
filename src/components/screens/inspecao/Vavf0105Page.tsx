    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .avf-r{min-height:100vh;background:#dfe4e0;font-family:'Inter',sans-serif;color:#1c2b22;display:flex;flex-direction:column}

        .avf-tb{height:52px;background:#16281d;display:flex;align-items:center;justify-content:space-between;padding:0 20px;flex-shrink:0;border-bottom:1px solid rgba(62,150,84,0.15)}
        .avf-tbl{display:flex;align-items:center;gap:10px}
        .avf-lg{width:28px;height:28px;background:#2f7d47;border-radius:6px;display:flex;align-items:center;justify-content:center}
        .avf-an{font-size:13px;font-weight:600;color:#e0f0e3;line-height:1.1}
        .avf-asb{display:block;font-size:9px;font-weight:400;color:#54655a}
        .avf-st{font-size:12.5px;font-weight:500;color:#3f8a58;padding-left:14px;margin-left:14px;border-left:1px solid rgba(255,255,255,0.08)}
        ...
        .avf-al{font-size:9.5px;font-weight:600;letter-spacing:0.8px;text-transform:uppercase;color:#94a49a;margin-right:4px;white-space:nowrap}
        ...
        .avf-bt-p{background:#16281d;color:#dff0e2;border-color:#16281d}
        .avf-bt-p:hover:not(:disabled){background:#1e3728}
        .avf-bt-p:disabled{opacity:0.5;cursor:not-allowed}
        .avf-bt-g{background:transparent;color:#46574c;border-color:#d4e8d0}
        .avf-bt-g:hover:not(:disabled){background:#f0f8ec;border-color:#a9b6ac;color:#1c2b22}
        ...
        .avf-sb-p{font-size:9.5px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:#6b7d71;background:#e0ede0;border:1px solid #c8dcc8;border-radius:20px;padding:3px 10px;white-space:nowrap}
        .avf-sb-l{flex:1;height:1px;background:#dbe8d5}
        .avf-sb-h{font-size:11px;color:#94a49a;white-space:nowrap}
        ...
        .avf-ct{font-size:12px;font-weight:600;color:#253a2d;text-transform:uppercase;letter-spacing:0.6px}
        ...
        .avf-l{font-size:10.5px;font-weight:600;color:#6b7d71;text-transform:uppercase;letter-spacing:0.4px;display:flex;align-items:center;gap:4px}
        .avf-lr{color:#c84040;font-size:12px;line-height:1}
        .avf-in{width:100%;height:36px;background:#f8fbf6;border:1.5px solid #d4e8cc;border-radius:7px;padding:0 10px;font-family:'Inter',sans-serif;font-size:13px;color:#1c2b22;outline:none;transition:border-color 0.13s,box-shadow 0.13s}
        .avf-in:focus{border-color:#2f7d47;box-shadow:0 0 0 2px rgba(62,150,84,0.1)}
        .avf-in::placeholder{color:#a9b6ac;font-size:12px}
        ...
        .avf-fts{display:flex;align-items:center;gap:6px;font-size:11.5px;color:#6b7d71}
        .avf-fts strong{color:#1c2b22;font-weight:600}
        ...
        .avf-spd{width:14px;height:14px;flex-shrink:0;border:2px solid #d4e8cc;border-top-color:#2f7d47;border-radius:50%;animation:avfSpin 0.65s linear infinite}
      ...
      <div className="avf-r">
        ...
        <footer className="avf-ft">
          ...
          <div className="avf-fts" style={{gap:8}}><span style={{color:"#a9b6ac",fontSize:11}}>GRUPO VENTURE LTDA</span></div>
        </footer>
      </div>
    </>
  );
