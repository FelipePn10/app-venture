    ...
    <>
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .ins8-r{min-height:100vh;background:#f0f4ee;font-family:'Inter',sans-serif;color:#1a2e22;display:flex;flex-direction:column}

        .ins8-tb{height:52px;background:#162e20;display:flex;align-items:center;justify-content:space-between;padding:0 20px;flex-shrink:0;border-bottom:1px solid rgba(62,150,84,0.15)}
        .ins8-tbl{display:flex;align-items:center;gap:10px}
        .ins8-lg{width:28px;height:28px;background:#3e9654;border-radius:6px;display:flex;align-items:center;justify-content:center}
        .ins8-an{font-size:13px;font-weight:600;color:#e0f0e3;line-height:1.1}
        .ins8-asb{display:block;font-size:9px;font-weight:400;color:#3d6b4d}
        .ins8-st{font-size:12.5px;font-weight:500;color:#5a9a6a;padding-left:14px;margin-left:14px;border-left:1px solid rgba(255,255,255,0.08)}
        ...
        .ins8-al{font-size:9.5px;font-weight:600;letter-spacing:0.8px;text-transform:uppercase;color:#96b8a0;margin-right:4px;white-space:nowrap}
        ...
        .ins8-bt-p{background:#162e20;color:#dff0e2;border-color:#162e20}
        .ins8-bt-p:hover:not(:disabled){background:#1e3a2a}
        .ins8-bt-p:disabled{opacity:0.5;cursor:not-allowed}
        .ins8-bt-g{background:transparent;color:#4a7060;border-color:#d4e8d0}
        .ins8-bt-g:hover:not(:disabled){background:#f0f8ec;border-color:#b0d4b8;color:#1a3828}
        ...
        .ins8-sb-p{font-size:9.5px;font-weight:700;letter-spacing:1.2px;text-transform:uppercase;color:#5a8068;background:#e0ede0;border:1px solid #c8dcc8;border-radius:20px;padding:3px 10px;white-space:nowrap}
        .ins8-sb-l{flex:1;height:1px;background:#dbe8d5}
        .ins8-sb-h{font-size:11px;color:#96b8a0;white-space:nowrap}
        ...
        .ins8-ct{font-size:12px;font-weight:600;color:#2a4a35;text-transform:uppercase;letter-spacing:0.6px}
        ...
        .ins8-l{font-size:10.5px;font-weight:600;color:#5a8068;text-transform:uppercase;letter-spacing:0.4px;display:flex;align-items:center;gap:4px}
        .ins8-lr{color:#c84040;font-size:12px;line-height:1}
        .ins8-in{width:100%;height:36px;background:#f8fbf6;border:1.5px solid #d4e8cc;border-radius:7px;padding:0 10px;font-family:'Inter',sans-serif;font-size:13px;color:#1a2e22;outline:none;transition:border-color 0.13s,box-shadow 0.13s}
        .ins8-in:focus{border-color:#3e9654;box-shadow:0 0 0 2px rgba(62,150,84,0.1)}
        .ins8-in::placeholder{color:#b0c8b8;font-size:12px}
        .ins8-in:disabled{background:#f0f4ee;color:#8aaa94;cursor:not-allowed;border-color:#e0ead8}
        ...
        .ins8-fts{display:flex;align-items:center;gap:6px;font-size:11.5px;color:#6a8a74}
        .ins8-fts strong{color:#1a2e22;font-weight:600}
        ...
        .ins8-spd{width:14px;height:14px;flex-shrink:0;border:2px solid #d4e8cc;border-top-color:#3e9654;border-radius:50%;animation:ins8Spin 0.65s linear infinite}
      ...
      <div className="ins8-r">
        ...
        <footer className="ins8-ft">
          ...
          <div className="ins8-fts" style={{gap:8}}><span style={{color:"#b0c8b8",fontSize:11}}>GRUPO VENTURE LTDA</span></div>
        </footer>
      </div>
    </>
  );
