            ...
            <div className="erp-list-panel">
              <div className="erp-fieldset">
                ...
                <div className="erp-fieldset-body">
                  ...
                  {/* Sem o teto, a política valia para qualquer valor de pedido:
                      o backend já aceitava a faixa completa e a tela só coletava o piso. */}
                  <div className="erp-field erp-c3"><label className="erp-label">Valor máx. bruto</label><input className="erp-input num" type="number" value={form.max_gross_value ?? ""} onChange={(e) => setForm((p) => ({ ...p, max_gross_value: Number(e.target.value) }))} /></div>
                  <div className="erp-field erp-c3"><label className="erp-label">Qtde mínima</label><input className="erp-input num" type="number" value={form.min_quantity ?? ""} onChange={(e) => setForm((p) => ({ ...p, min_quantity: Number(e.target.value) }))} /></div>
                  <div className="erp-field erp-c3"><label className="erp-label">Qtde máxima</label><input className="erp-input num" type="number" value={form.max_quantity ?? ""} onChange={(e) => setForm((p) => ({ ...p, max_quantity: Number(e.target.value) }))} /></div>
